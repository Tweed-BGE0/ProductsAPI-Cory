...
async function processLineByLine(path, tableName, columnNames) {
  ...
  for await (const line of rl) {
    ...
    var url = split[2].replace(/['"]+/g, '')
    var thumbnail_url = split[3].replace(/['"]+/g, '')
...
processLineByLine('/Users/coryzauss/Projects/sdc/Data/photos.csv', 'photos', ['id', 'style_id', 'url', 'thumbnail_url']);